const Activities = [
	{
		...
		reviews: "",
		rating: "",
		banner: "/disney-banner.webp",
		square: "/disney-square.webp",
	...
	},
	{
		...
		reviews: "",
		rating: "",
		banner: "/lacma-banner.webp",
		square: "/lacma-square.webp",
	...
	},
	{
		...
		reviews: "",
		rating: "",
		banner: "/aquarium-banner.webp",
		square: "/aquarium-square.webp",
	...
	},
	{
		...
		reviews: "",
		rating: "",
		banner: "/laguna-banner.webp",
		square: "/laguna-square.webp",
	...
	},
	{
		...
		description:
			"Embark on an unforgettable date at Universal Studios Hollywood, a captivating haven that promises an extraordinary experience for couples. Nestled in the heart of Los Angeles, this enchanting theme park offers a delightful blend of thrilling rides, immersive attractions, and captivating shows, all designed to ignite sparks of excitement between you and your partner. From adrenaline-pumping adventures through iconic movie sets to magical encounters with beloved characters, Universal Studios Hollywood transports you into the enchanting world of cinema. Wander hand in hand through the bustling streets of the Wizarding World of Harry Potter, savoring the whimsical ambiance and indulging in delightful treats. Lose yourselves in the magic of captivating performances and unforgettable spectacles, as the park comes alive with entertainment that will leave you mesmerized. With each turn, a new chapter of shared memories unfolds, leaving you both longing for more. So, ignite the spark of romance and immerse yourselves in the wonders of Universal Studios Hollywood, where love and magic intertwine to create an extraordinary date you'll cherish forever.",
		address: "100 Universal City Plaza, Universal City, CA 91608",
		reviews: "",
		rating: "",
		banner: "/universal-banner.webp",
		square: "/universal-square.webp",
	...
	},
	{
		...
		description:
			"Step into a world of vibrant energy and eclectic treasures at the renowned Melrose Trading Post, where every Sunday promises a whimsical adventure. As you stroll through the bustling open-air market, hand in hand, you'll be enveloped by a kaleidoscope of sights, sounds, and scents that awaken the senses and ignite curiosity. Lose yourselves in the maze of artisanal stalls, each one housing unique handcrafted jewelry, vintage fashion pieces, and one-of-a-kind art that tell stories of a bygone era. The atmosphere is alive with live music, captivating street performances, and the joyful chatter of fellow explorers. Indulge in mouthwatering treats from the food vendors, savoring every bite while stealing glances at each other's smiles. With every step, you'll unearth hidden treasures and create unforgettable memories, forging a bond that will forever link your hearts to this enchanting haven of creativity and romance.",
		address: "7850 Melrose Avenue, Los Angeles, California, 90046",
		reviews: "",
		rating: "",
		banner: "/melrose-banner.webp",
		square: "/melrose-square.webp",
